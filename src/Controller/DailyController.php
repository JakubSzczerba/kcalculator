...
class DailyController extends AbstractController
{
    ...
    public function __construct(ProductRepository $productRepository, EntriesRepository $entriesRepository, EntityManagerInterface $entityManager)
    {
    ...
    public function addEntry(Request $request, Products $product, int $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // TODO change logic -> calculations to data provider and create factory for entry.
